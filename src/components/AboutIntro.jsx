    ...
    return (
        <div className="bg-linear-120 from-shade1 to-shade2 py-10 sm:py-12 lg:py-14 xl:py-24 flex flex-col items-center gap-3 lg:gap-5 px-5">
            ...
            <div className="flex flex-col items-center gap-3 md:gap-5 xl:gap-6 sm:w-2/3 md:w-3/5 lg:w-3/6 xl:w-5/12">
                <h3 className="font-poppins text-2xl sm:text-3xl lg:text-4xl 2xl:text-5xl text-white font-semibold"> About <span className="bg-yellow-400 bg-clip-text text-transparent"> TextUtils </span> </h3>
                <p className="text-center text-sm lg:text-base xl:text-lg font-gg text-white font-medium lg:font-semibold">
                    We're on a mission to revolutionize how people write, collaborate, and share ideas. Our story began with a simple belief: everyone deserves access to powerful, intuitive writing tools.
                </p>
            </div>
